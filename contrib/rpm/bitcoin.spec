...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 11989
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 10989
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 111989
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 110989
...
if [ $1 -eq 0 ]; then
	...
	%{_sbindir}/semanage port -d -p tcp 10989
	%{_sbindir}/semanage port -d -p tcp 111989
	%{_sbindir}/semanage port -d -p tcp 110989
	for selinuxvariant in %{selinux_variants}; do
