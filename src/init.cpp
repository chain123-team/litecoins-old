...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/litecoins-project/litecoins>";
    const std::string URL_WEBSITE = "<https://litecoins.org>";
