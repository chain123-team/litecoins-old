...
const char * const BITCOIN_CONF_FILENAME = "litecoins.conf";
const char * const BITCOIN_PID_FILENAME = "litecoins.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/LitecoinS";
#else
    // Unix
